        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              <img src="/public/logo.jpeg" alt="SSM Technologies" className="h-10 w-10 rounded-full" />
              <div>
                <h3 className="text-xl font-bold">SSM Technologies</h3>
                <p className="text-sm text-gray-300">Coaching Institute</p>
              </div>
            </div>
            <p className="text-gray-300 text-sm leading-relaxed">
              Empowering students with quality education and professional training. 
              Join us to achieve your career goals with expert guidance and comprehensive courses.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300 text-sm">info@ssmtechnologies.co.in</p>
              </div>
            </div>
          </div>
        </div>
